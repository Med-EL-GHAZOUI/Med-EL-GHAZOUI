...
* **Restaurant Platform** (Angular/Nest.js) - Full-stack ordering system.
* **HR Management App** (Java) - Comprehensive human resource management solution.
* **Conference Management System** (Django) - Web application for managing events.
* **Homework Management App** (Laravel) - Educational tool for tracking assignments.
* **Medical Center Management** (C++) - A desktop app for managing patient records.
* **GPEC Web Application** - Management tool for the agricultural sector (COPAG).
* **E-Learning Platform** (HTML/JS) - Online course interface.
